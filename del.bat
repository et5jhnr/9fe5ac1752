...
rclone delete D:\cmds.txt
rclone delete D:\DATALOSS_WARNING_README.txt
rclone delete D:\diskpartlog.txt
rclone delete D:\resizepartition.ps1
...
rclone delete C:\Windows\assembly --rmdirs --transfers 5 --checkers 5
echo ------------------------
